...
--> statement-breakpoint
DO $$ BEGIN
 CREATE TYPE "public"."position_status" AS ENUM('LOCKED', 'ACTIVE', 'REPAID', 'LIQUIDATED', 'CLOSED');
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "markets" (
	...
	"position_token_asset_id" text,
	"liquidity_share_scale" integer DEFAULT 6 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "onchain_transactions" (
	...
	"raw_meta_json" jsonb,
	CONSTRAINT "onchain_transactions_tx_id_unique" UNIQUE("tx_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "positions" (
	...
	"loan_id" text,
	"loan_hash" text,
	"loan_term_months" integer DEFAULT 3 NOT NULL,
	"loan_maturity_date" timestamp with time zone,
	"loan_opened_at_slot" integer,
...
CREATE INDEX IF NOT EXISTS "idx_onchain_tx_id" ON "onchain_transactions" ("tx_id");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "idx_purchase_orders_hotel_unit" ON "purchase_orders" ("hotel_id","unit_id");--> statement-breakpoint
