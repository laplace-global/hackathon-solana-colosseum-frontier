        ...
        <div className="relative aspect-[16/9] overflow-hidden rounded-lg bg-card">
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center">
              <p className="text-6xl font-bold text-muted-foreground">{selectedImage + 1}</p>
              <p className="mt-2 text-sm text-muted-foreground">{mockImages[selectedImage].alt}</p>
            </div>
          </div>
      ...
      <Dialog open={isFullscreen} onOpenChange={setIsFullscreen}>
        <DialogContent className="max-h-[90vh] max-w-[90vw] p-0">
          <div className="relative aspect-[16/9] bg-card">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <p className="text-8xl font-bold text-muted-foreground">{selectedImage + 1}</p>
                <p className="mt-4 text-lg text-muted-foreground">{mockImages[selectedImage].alt}</p>
              </div>
            </div>
