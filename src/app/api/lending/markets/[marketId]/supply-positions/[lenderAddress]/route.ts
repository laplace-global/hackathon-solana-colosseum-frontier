...
import { getSupplyPositionWithMetrics } from '@/lib/lending/solana-service';
import {
...
export async function GET(_request: Request, context: RouteContext) {
  try {
    ...
    if (!isValidLendingBackendAddress(lenderAddress)) {
      return NextResponse.json(
        {
          success: false,
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        market: {
          ...
          debtAssetId: result.market.debtAssetId ?? result.market.debtIssuer,
