        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="text-eyebrow text-primary">Position</p>
              <h1 className="font-serif text-3xl font-light text-foreground md:text-4xl">Investment Details</h1>
        ...
        <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <Card className="rounded-none">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-eyebrow text-muted-foreground">Current Value</p>
                  <p className="mt-2 font-serif text-3xl font-light text-foreground">${currentValue.toFixed(2)}</p>
          ...
          <Card className="rounded-none">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-eyebrow text-muted-foreground">Total Return</p>
                  <p className="mt-2 font-serif text-3xl font-light text-foreground">${totalReturn.toFixed(2)}</p>
                  <p className="mt-1 text-xs text-muted-foreground">{totalReturnPercentage.toFixed(1)}% total</p>
                </div>
                <div className="bg-primary/10 p-3">
          ...
          <Card className="rounded-none">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-eyebrow text-muted-foreground">Dividends Earned</p>
                  <p className="mt-2 font-serif text-3xl font-light text-foreground">${totalDividends.toFixed(2)}</p>
                  <p className="mt-1 text-xs text-muted-foreground">{transactions.filter(t => t.type === 'dividend').length} payments</p>
                </div>
                <div className="bg-primary/10 p-3">
          ...
          <Card className="rounded-none">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-eyebrow text-muted-foreground">Annualized Return</p>
                  <p className="mt-2 font-serif text-3xl font-light text-foreground">{annualizedReturn.toFixed(1)}%</p>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">Annual Return Rate</span>
                      <span className="font-medium">{purchase.estimatedROI}%</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-sm text-muted-foreground">Expected Annual Income</span>
                      <span className="font-medium">${(purchase.totalPrice * purchase.estimatedROI / 100).toFixed(2)}</span>
                    </div>
                    {hotel && (
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-muted-foreground">Buyback Option</span>
